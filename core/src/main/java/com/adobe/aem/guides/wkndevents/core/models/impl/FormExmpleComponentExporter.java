...
//import com.adobe.aem.guides.wkndevents.core.models;
...
@Model(
        ...
        adapters = { FormExmpleComponentExporter.class, ComponentExporter.class },

        // The resourceType is required if you want Sling to "naturally" expose this model as the exporter for a Resource.
        resourceType = FormExmpleComponentExporter.RESOURCE_TYPE,
...
@JsonSerialize(as = FormExmpleComponentExporter.class)

// Make sure the Model implementation implements (or the Model interface extends) com.adobe.cq.export.json.ComponentExporter.
public class FormExmpleComponentExporter implements ComponentExporter {
    static final String RESOURCE_TYPE = "wknd-events/components/content/formExample";
    ...
    public String getMessage() {
        return String.format("This Is Reggies message!", request.getResource().getResourceType());
    }
    ...
    //@Required
    //@Source(text2)
    private String text2 = "Password3333:";
